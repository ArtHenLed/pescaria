...
# Adding a try-except block for the entire API call section for better error handling
try:
    weather_response = requests.get(
        ...
        params={
            ...
            "start": f"{data_sabado}T00:00:00+00:00", "end": f"{data_domingo}T23:59:59+00:00",
            "source": "noaa"
        },
